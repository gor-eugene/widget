...
import { AmoPage } from './route.interface'
import { AmoWidget } from '../../widget'

export class AmoWidgetRoute {
  constructor(private readonly widget: AmoWidget) {}

  getCurrent(): { page: AmoPage; cardId?: number; pipelineId?: number; tasksPeriod?: string } {
    const h: string = this.widget.window.location.href
